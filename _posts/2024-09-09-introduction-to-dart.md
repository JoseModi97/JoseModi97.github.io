...
: Visit the official Dart website [Releases](https://dart.dev/) or click here (Download page for Dart SDK) to go directly to the download page and download the Dart SDK that is appropriate for your version of Windows.
